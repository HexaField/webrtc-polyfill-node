...
export class RTCTrackEvent extends Event {
  ...
  constructor (type = 'track', init) {
    ...
    if (!init.streams) throw new TypeError("Failed to construct 'RTCTrackEvent': Failed to read the 'streams' property from 'RTCTrackEventInit': Required member is undefined.")
    if (init.receiver.constructor !== RTCRtpReceiver) throw new TypeError("Failed to construct 'RTCTrackEvent': Failed to read the 'receiver' property from 'RTCTrackEventInit': Failed to convert value to 'RTCRtpReceiver'.")
    if (init.track.constructor !== MediaStreamTrack) throw new TypeError("Failed to construct 'RTCTrackEvent': Failed to read the 'track' property from 'RTCTrackEventInit': Failed to convert value to 'MediaStreamTrack'.")
    if (init.transceiver.constructor !== RTCRtpTransceiver) throw new TypeError("Failed to construct 'RTCTrackEvent': Failed to read the 'transceiver' property from 'RTCTrackEventInit': Failed to convert value to 'RTCRtpTransceiver'.")
