...
export default class RTCPeerConnection extends EventTarget {
  ...
  constructor (init = {}) {
    ...
    this.#peerConnection.onTrack(track => {
      console.log(track, track.mid(), Object.entries(track))
      ...
      this.dispatchEvent(new RTCTrackEvent('track', { track: mediastream, receiver: transceiver.receiver, transceiver, streams: track.streams }))
    })
  ...
  addTrack (track, ...streams) {
    ...
    if (unused) {
      const _track = this.#setUpTrack(unused.media, track, unused, 'sendonly')
      _track.streams = streams
